...
class thankie extends StatelessWidget {
  const thankie({Key? key}) : super(key: key);
  @override
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      Padding(
                        padding: const EdgeInsets.all(8.0),
                        child: Text('Thank you for using AgroRansom. We shall get back to you after contacting your market.',
                        style: TextStyle(
                          fontSize: 25,
                          color: Colors.white,
                        ),
